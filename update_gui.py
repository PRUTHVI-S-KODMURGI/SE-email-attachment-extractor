...
folder_path_entry.place(x=200, y=200)
...
no_emails_entry.place(x=525, y=350)

# Verbose displaying widget
verbose_area = LabelFrame(root, bd=2, relief="groove")
verbose_area.place(x=900, y=100, width=500, height=400)
...
extract_button.place(x=300, y=600)
